...
<div class="common-buttons">
  ...
  <table  class="rwd-table">
        ...
        <tr class="KOTRA-fontsize-80">
          <td>1</td>
          <td v-on:click="fnView">사이트 사용 문의</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
       ...
       <tr class="KOTRA-fontsize-80">
          <td>2</td>
          <td v-on:click="fnView">회원탈퇴는 어떻게 하나요...?</td>
          <td >user01</td>
          <td>2023.04.27</td>
        </tr>
        ...
        <tr class="KOTRA-fontsize-80">
          <td>3</td>
          <td v-on:click="fnView">광고제의 드리고 싶습니다</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
         ...
         <tr class="KOTRA-fontsize-80">
          <td>4</td>
          <td v-on:click="fnView">유료결제 서비스가 있나요?</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr> 
        ...
        <tr class="KOTRA-fontsize-80">
          <td>5</td>
          <td v-on:click="fnView">사이트 개선 요청합니다.</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
        ...
        <tr class="KOTRA-fontsize-80">
         <td>6</td>
          <td v-on:click="fnView">소셜로그인 불가</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
        ...
        <tr class="KOTRA-fontsize-80">
         <td>7</td>
          <td v-on:click="fnView">어플다운 가능여부 문의</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
        ...
        <tr class="KOTRA-fontsize-80">
         <td>8</td>
          <td v-on:click="fnView">채팅은 어떻게 하나요?</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
        ...
        <tr class="KOTRA-fontsize-80">
         <td>9</td>
          <td v-on:click="fnView">마이페이지 접속시 에러발생</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
        ...
        <tr class="KOTRA-fontsize-80">
         <td>10</td>
          <td v-on:click="fnView">챗봇이용 문의</td>
          <td>user01</td>
          <td>2023.04.27</td>
        </tr>
