...
export default {
  ...
  methods: {
    ...
    //이메일 인증코드 체크
    emailAuthCheck() {
      let inputCode = document.getElementById("eamilAuthNumber");
      console.log(inputCode.value);
      if (inputCode.value != emailCode) {
        console.log("유저입력 : " + inputCode.value);
