...
import AdminQnADetail from '@/views/admin/AdminQnADetail.vue'
export default {
 name: 'AdminQnADetail',
 components: {AdminQnADetail, dayjs},
  data() { //변수생성
    return {
  ...
  methods: {
    fnGetView() {
      ...
      axios.get("/admin/AdminQnADetail/" + this.qnaNo, {
    ...
    fnDelete() {
      ...
      axios.delete(`/admin/AdminQnADelete/${this.qnaNo}`, {
        params: this.requestBody
      }).then(() => {
        alert('삭제되었습니다.');
        this.fnList();
